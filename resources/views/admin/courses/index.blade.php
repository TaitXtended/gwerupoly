...
@section('content')
            <div class="layout-px-spacing">                
                                ...
                                <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                                    <form class="form-inline my-2 my-lg-0">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control product-search" id="input-search" placeholder="Search course...">
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <div class="item-content">
                                        <div class="user-profile">
                                            ...
                                            <div class="user-meta-info ml-5">
                                                <p class="user-name" data-name="{{$course->coursename}}">{{$course->coursename}}</p>
                                                {{-- <p class="user-work" data-occupation="Web Developer">Web Developer</p> --}}
                                            </div>
                                        </div>
                                        
                                        <div class="user-email">
                                            <p class="info-title">Course Code </p>
                                            <p class="usr-email-addr" data-location="{{$course->coursecode}}">{{$course->coursecode}}</p>
                                        </div>
                                        <div class="user-location">
                                            <p class="info-title">Department </p>
                                            <p class="usr-location" data-phone="{{$course->department}}">{{$course->department}}</p>
                                        </div>
                                        <div class="actionbtn">
                                            <a href="/courses/{{$course->id}}/edit" ><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 "><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                            <a href="/courses/{{$course->id}}/delete" onClick="return confirm('Are you sure you want to delete?')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-minus  "><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="23" y1="11" x2="17" y2="11"></line></svg></a>
                                        </div>
                                    </div>
                                </div>
                        @endforeach
                ...
                @else
                <p>You have no courses yet..... click the add button to create a course</p>
