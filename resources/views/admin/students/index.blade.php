                                ...
                                <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                                    <form class="form-inline my-2 my-lg-0">
                                        <div class="">
                                            ...
                                            <input type="text" class="form-control product-search" id="input-search" placeholder="Search Reg Number...">
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="items">
                                    <div class="item-content">
                                        <div class="user-profile">
                                            ...
                                            <img src="{{asset('storage/studentprofile/'.$student->profilephoto)}}" alt="{{$student->profilephoto}}">
                                            <div class="user-meta-info">
                                                <p class="user-name" data-name="{{$student->fname.' '.$student->surname}}">{{$student->fname.' '.$student->surname}}</p>
                                                <p class="user-work" data-occupation="{{$student->regnum}}">{{$student->regnum}}</p>
                                            </div>
                                        </div>
                                        <div class="user-email">
                                            <p class="info-title">Email: </p>
                                            <p class="usr-email-addr" data-email="{{$student->email}}">{{$student->email}}</p>
                                        </div>
                                        <div class="user-location">
